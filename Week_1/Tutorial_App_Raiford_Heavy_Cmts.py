...
def generate_random_example():                                          # Function to generate a random example   
    examples = {                                                        
        ...
        "int": [-1998, -1987, -1872, -1819, -1747, -1724, -1620, -1576, -1500, -1422, -1354, -1081, -990, -986, 
                ...
                1700, 1775, 1884, 1954],                                
        "float": [33.2627,   77.4039,   6.0686,   70.0330,   64.7930,   54.5252,   62.8744,   39.9176,   9.1075,   
        ...
        "str": ["jxiae", "emsddz", "bpfs", "cipha", "mmxvm", "scqtreh", "qqeqav", "tnjvdws", "xyqrb", "ghyoen", 
